...
import br.gov.frameworkdemoiselle.validation.internal.validator.InscricaoEstadualValidator;
...
public @interface InscricaoEstadual {
	...
	String message() default "{br.gov.frameworkdemoiselle.inscricaoestadual}";

	Class<? extends Payload>[] payload() default {};
	
	PatternInscricaoEstadual pattern();
