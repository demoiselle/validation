...
import br.gov.frameworkdemoiselle.validation.internal.validator.AllowedValuesValidator;
...
public @interface AllowedValues {
	...
	/**
	 * List of payload classes that can be used by extensions to add behaviour to this constraint. Defaults to an empty array.
	 */
